		...
		A2(
			...
			$elm$core$Basics$always(
				$elm$browser$Browser$Events$onMouseUp(
					$elm$json$Json$Decode$succeed($author$project$Main$Released))),
			model.pressed));
};
...
var $author$project$Main$applySelectionMode = F3(
	function (mode, cordinate, set) {
		if (mode.$ === 'Selection') {
			return A2($elm$core$Set$insert, cordinate, set);
		} else {
			...
			case 'Pressed':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							mode: mode,
							pressed: $elm$core$Maybe$Just(cordinate),
							selectedSet: A3($author$project$Main$applySelectionMode, mode, cordinate, model.selectedSet)
						}),
					$elm$core$Platform$Cmd$none);
			case 'OverCordinate':
				var cordinate = msg.a;
							...
							selectedSet: A2(
								...
								A2(
									...
									function (pressed) {
										return A3(
											$elm$core$List$foldl,
											$author$project$Main$applySelectionMode(model.mode),
											model.selectedSet,
											A2($author$project$Main$getCordinatesBetween, pressed, cordinate));
									},
									model.pressed))
						}),
					$elm$core$Platform$Cmd$none);
				...
				function (_v0) {
					return A2(
						...
						$elm$html$Html$Events$onMouseOver(
							$author$project$Main$OverCordinate(cordinate)),
						ls);
				},
				maybePressed));
	});
